...
namespace Utils {
    /// <summary>
    /// Credits to Bunny83 · Jul 13, 2011 at 05:50 PM (https://answers.unity.com/questions/143025/more-questions-on-generating-camera-frustrum.html)
    /// </summary>
    public static class CameraExtension {
        ...
        public static Mesh GenerateFrustumMesh(this Camera cam, float farPlaneDistance) {
            Mesh mesh = new Mesh();
            ...
            v[4].z = v[5].z = v[6].z = v[7].z = farPlaneDistance;
            ...
            for (int i = 0; i < 6; i++) {
                Vector3 faceNormal = Vector3.Cross(vertices[i * 4 + 2] - vertices[i * 4 + 1],
